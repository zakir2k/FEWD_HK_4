$(document).ready(function() {
    ...
    function resetHighlight(){
        ...
        highlightArray = {
            ...
            n123 : ["#single1", "#single2", "#single3", "#twodice12", "#twodice13", "#twodice23", "#total6", "#even", "#small"],
            n124 : ["#single1", "#single2", "#single4", "#twodice12", "#twodice14", "#twodice24", "#total7", "#odd", "#small"],
            ...
            n134 : ["#single1", "#single3", "#single4", "#twodice13", "#twodice14", "#twodice34", "#total8", "#even", "#small"],
            n234 : ["#single2", "#single3", "#single4", "#twodice23", "#twodice24", "#twodice34", "#total9", "#odd", "#small"],
            n145 : ["#single1", "#single4", "#single5", "#twodice14", "#twodice15", "#twodice45", "#total10", "#even", "#small"],
            n236 : ["#single2", "#single3", "#single6", "#twodice23", "#twodice26", "#twodice36", "#total11", "#odd", "#big"],
            n156 : ["#single1", "#single5", "#single6", "#twodice15", "#twodice16", "#twodice56", "#total12", "#even", "#big"],
            n256 : ["#single2", "#single5", "#single6", "#twodice25", "#twodice26", "#twodice56", "#total13", "#odd", "#big"],
            n235 : ["#single2", "#single3", "#single5", "#twodice23", "#twodice25", "#twodice35", "#total10", "#even", "#small"],
            n245 : ["#single2", "#single4", "#single5", "#twodice24", "#twodice25", "#twodice45", "#total11", "#odd", "#big"],
            n246 : ["#single2", "#single4", "#single6", "#twodice24", "#twodice26", "#twodice46", "#total12", "#even", "#big"],
            n346 : ["#single3", "#single4", "#single6", "#twodice34", "#twodice36", "#twodice46", "#total13", "#odd", "#big"],
            n356 : ["#single3", "#single5", "#single6", "#twodice35", "#twodice36", "#twodice56", "#total14", "#even", "#big"],
            n456 : ["#single4", "#single5", "#single6", "#twodice45", "#twodice46", "#twodice56", "#total15", "#odd", "#big"],
            n345 : ["#single3", "#single4", "#single5", "#twodice34", "#twodice35", "#twodice45", "#total12", "#even", "#big"],
            }
